...
boxWrapper: {
 marginLeft:'20px'
  ...
  activeTrainingCenerIcon: {
    ...
    beginbreakicon: {
      background: 'url(http://localhost:8080/img/begin-breakicon.png) no-repeat center',
      width: '55px',
      height: '29px',
      marginTop: '5px',
      float: 'left',
    ...
    endbreakicon: {
      background: 'url(http://localhost:8080/img/end-breakicon.png) no-repeat center',
      width: '62px',
      height: '29px',
      marginTop: '5px',
      float: 'left',
...
breakLast: {
  ...
  loaderImage: {
	...
	upload: {
		"background": "url(http://localhost:8080/img/filetype.png) center no-repeat",
	...
	icon: {
		"background": "url(http://localhost:8080/img/icon.png) center no-repeat",
		"height": "16px",
		"width": "16px",
		"float": "left",
